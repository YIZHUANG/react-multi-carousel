...
| partialVisible           | `boolean`         | `false`                           | Show partial next slides. This is use with the `responsive` prop, see example for details                                                                                |
...
| pauseOnHover             | `boolean`         | `true`                            | Pause the animation from rtl or ltr on hover                                                                                                                             |
