...
var CarouselItems = function(_a) {
  ...
  var _b = utils_1.getInitialState(state, props),
    flexBisis = _b.flexBisis,
    shouldRenderOnSSR = _b.shouldRenderOnSSR,
    domFullyLoaded = _b.domFullyLoaded,
    paritialVisibilityGutter = _b.paritialVisibilityGutter;
  if (infinite) {
    return clones.map(function(child, index) {
      return React.createElement(
        "li",
        {
          key: index,
          "aria-hidden": utils_1.getIfSlideIsVisbile(index, state)
            ? "false"
            : "true",
          "data-index": index,
          style: {
